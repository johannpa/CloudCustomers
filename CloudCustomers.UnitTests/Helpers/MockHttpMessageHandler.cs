...
namespace CloudCustomers.UnitTests.Helpers
{
    ...
    {
        internal static Mock<HttpMessageHandler> SetupBasicGetRessourceList(List<T> expectedResponse)
        {
        ...
        internal static Mock<HttpMessageHandler> SetupBasicGetRessourceList(List<User> expectedResponse, string endpoint)
        {
            var mockResponse = new HttpResponseMessage(System.Net.HttpStatusCode.OK)
            {
                Content = new StringContent(JsonConvert.SerializeObject(expectedResponse))
